...
// src/components/WhatsAppBubble/WhatsAppBubble.jsx
//
// Global floating WhatsApp bubble — drop this
// once in your root layout (App.jsx or Layout.jsx).
...
export default function WhatsAppBubble() {
  ...
  // Bubble fades in after 1.5s so it doesn't
  // compete with the page's entrance animations
  useEffect(() => {
